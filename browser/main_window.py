...
class mainWindow(QMainWindow):
    ...
    def init_ui(self):
        ...
        self.stop_btn.setIcon(
            QIcon(os.path.join("resources", "icons", "cross.png")))
        ...
        ViewHistory.setIcon(
            QIcon(os.path.join("resources", "icons", "history.png")))
        ...
        HelpMenu.setIcon(
            QIcon(os.path.join("resources", "icons", "question.png")))

        # About action
        AboutAction = QAction("About this browser", self)
        AboutAction.setIcon(
            QIcon(os.path.join("resources", "icons", "info.png")))
        ...
        self.add_new_tab(
            QUrl(browser.settings_data["startupPage"]), "Homepage")
    ...
    def goToHome(self):
        self.tabs.currentWidget().setUrl(
            QUrl(browser.settings_data["homeButtonPage"]))
    ...
    def tab_open_doubleclick(self, i):
        if i == -1:  # No tab under the click
            self.add_new_tab(
                QUrl(browser.settings_data["newTabPage"]), label="New tab")
    ...
    def update_title(self, browser):
        ...
        if 0 > len(title):
            self.setWindowTitle("{} - Pynexus".format(title))

        else:
            self.setWindowTitle("Pynexus")
